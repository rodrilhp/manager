    ...
    return (
        <div className="w-full animate-fade-in-up">
            <div className="mt-6 p-12 bg-white border border-gray-200 rounded-xl shadow-sm flex flex-col items-center justify-center text-center">
                ...
                <h3 className="text-base font-medium text-gray-900 mb-1">Métricas e KPIs</h3>
                <p className="text-sm text-gray-500 max-w-sm">
                    Acompanhamento de avaliações, metas e indicadores organizacionais em desenvolvimento.
                </p>
            </div>
        </div>
    );
